...
def glob_tool(pattern: str, path: str = None) -> str:
    """
...
if __name__ == "__main__":
    ...
    try:
        ...
        result3 = glob_tool(pattern="*.md", path=test_dir)
        ...
        result4 = glob_tool(pattern="subdir/*.txt", path=test_dir)
        ...
        result5 = glob_tool(pattern="*.py", path=test_dir)
        ...
        result6 = glob_tool(pattern="*.txt", path="/nonexistent/directory")
        ...
        try:
            result7 = glob_tool(pattern="test_glob_*.txt")
